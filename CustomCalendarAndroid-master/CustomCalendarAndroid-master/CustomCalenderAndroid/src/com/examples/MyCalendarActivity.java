...
public class MyCalendarActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Locale.getDefault()은 유저 디바이스의 지역을 Locale로 반환.
		// public static synchronized Calendar getInstance(Locale locale) {
		// 		return new GregorianCalendar(local);
		// }
		...
		//	}
		// defaultLocale이 US로 설정 되어있는데 어떻게 디바이스 지역에 맞게 값이 변하는가?
		
		
		//_calendar = new GregorianCalendar(Locale.getDefault()); 이것도 가능하다.

		_calendar = Calendar.getInstance(Locale.getDefault());
		
		
		Log.e("Locale",""+Locale.getDefault());
